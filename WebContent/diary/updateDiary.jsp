...
<html>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-9">
				<form name="addDiary">
					<input type="hidden" name="diaryNo" value="${ diary.diaryNo }"/> <!-- hidden으로 기록 넘버 값 넘김 -->
					...
					<div class="row">
						<div class="col-md-12">
							<div class="row">
								...
								<div class="col-md-11">
									<input class="form-control" name="location" type="text" value="${ diary.location }" readonly>
									<input class="form-control" name="latitude" type="hidden" value="${ diary.latitude }">
									<input class="form-control" name="longitude" type="hidden" value="${ diary.longitude }">
								</div>
							</div>
						</div>
					</div><br>
						...
						<div class="col-md-3">
							<div class="row">
								<div class="custom-control custom-radio">
      									<input type="radio" value = "t" id="customRadio1" name="isPublic" class="custom-control-input" 
      									${ diary.isPublic eq 't'.charAt(0) ? "checked" : "" }>
    							...
    							<div class="custom-control custom-radio">
      								...
      								${ diary.isPublic eq 'f'.charAt(0) ? "checked" : "" }>
