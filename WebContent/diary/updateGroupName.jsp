...
<html>
	<head>
		...
		$(function() {
			...
			$("button:contains('수정')").on("click", function() {
				$.ajax(
						{
							url : "/diary/rest/updateGroupName" ,
							method : "POST" ,
							dataType : "text" ,
							data : {
								groupNo : ${ groupNo }, 
	...
	<div>
		<input type="text" id="updateGroupName" name="updateGroupName" style="height: 38pt;" placeholder="그룹명을 입력해주세요" value=""/>
